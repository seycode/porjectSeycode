...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("192.168.99.7"), 12124)}, "/Users/niklas/Dropbox/programmierung/Fuse/SeyCode/SeyCode.unoproj", GetBundle, new string[] { })
{
...
{
return Uno.IO.Bundle.Get("SeyCode");
}
}
}
