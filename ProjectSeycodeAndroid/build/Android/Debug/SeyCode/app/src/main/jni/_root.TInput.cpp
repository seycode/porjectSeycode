...
// {
// static TInput() :4
static void TInput__cctor_3_fn(uType* __type)
{
}

static void TInput_build(uType* type)
{
...
::g::Fuse::Controls::TextInputControl_type* TInput_typeof()
{
    ...
    options.ObjectSize = sizeof(TInput);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextInputControl_type);
    type = (::g::Fuse::Controls::TextInputControl_type*)uClassType::New("TInput", options);
    type->SetBase(::g::Fuse::Controls::TextInput_typeof());
    type->fp_build_ = TInput_build;
    type->fp_ctor_ = (void*)TInput__New4_fn;
    type->fp_cctor_ = TInput__cctor_3_fn;
...
{
    *__retval = TInput::New4();
}

// public TInput() [instance] :8
void TInput::ctor_8()
{
    ctor_7();
    InitializeUX();
...
void TInput::InitializeUX()
{
    ...
    Padding(::g::Uno::Float4__New2(0.0f, 0.0f, 0.0f, 3.0f));
...
// public TInput New() [static] :8
TInput* TInput::New4()
{
    TInput* obj1 = (TInput*)uNew(TInput_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
