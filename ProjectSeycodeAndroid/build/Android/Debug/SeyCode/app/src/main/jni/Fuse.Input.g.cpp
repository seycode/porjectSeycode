...
// /usr/local/share/uno/Packages/FuseCore/0.32.14/Input/$.uno
// ----------------------------------------------------------
...
static void Focus_build(uType* type)
{
    ...
    ::TYPES[12] = ::g::Fuse::VisualEvent_typeof()->MakeType(::g::Fuse::Input::FocusLostHandler_typeof(), ::g::Fuse::Input::FocusLostArgs_typeof());
    type->SetFields(0,
...
static void FocusPrediction_build(uType* type)
{
    ...
    ::TYPES[3] = ::g::Fuse::Node_typeof();
    ::TYPES[16] = ::g::Uno::Predicate_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[17] = ::g::Uno::Func1_typeof()->MakeType(::g::Fuse::Visual_typeof(), ::g::Fuse::Visual_typeof());
}
...
::g::Fuse::Visual* FocusPrediction::LastVisualChild(::g::Fuse::Visual* visual)
{
    ...
    for (int i = ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(uPtr(visual)->Children()), ::TYPES[13/*Uno.Collections.ICollection<Fuse.Node>*/])) - 1; i >= 0; i--)
    {
        ::g::Fuse::Visual* c = uAs< ::g::Fuse::Visual*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(uPtr(visual)->Children()), ::TYPES[14/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret3), ret3), ::TYPES[2/*Fuse.Visual*/]);
...
::g::Fuse::Visual* FocusPrediction::NextSibling1(::g::Fuse::Visual* parent, ::g::Fuse::Visual* child)
{
    int ret4;
    ::g::Fuse::Node* ret5;
    int count = ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(uPtr(parent)->Children()), ::TYPES[13/*Uno.Collections.ICollection<Fuse.Node>*/]));
    int index = (::g::Uno::Collections::EnumerableExtensions__IndexOf_fn(::TYPES[15/*Uno.Collections.EnumerableExtensions.IndexOf<Fuse.Node>*/], parent->Children(), child, &ret4), ret4);
    int offset = index + 1;
    ...
    if (offset < count)
        ...
        {
            ::g::Fuse::Visual* c = uAs< ::g::Fuse::Visual*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(uPtr(parent)->Children()), ::TYPES[14/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret5), ret5), ::TYPES[2/*Fuse.Visual*/]);
...
::g::Fuse::Visual* FocusPrediction::Predict(::g::Fuse::Visual* visual, uDelegate* filter, uDelegate* getChild, uDelegate* getSibling)
{
    ...
    if (::g::Uno::Collections::ICollection::Count(uInterface(uPtr(uPtr(visual)->Children()), ::TYPES[13/*Uno.Collections.ICollection<Fuse.Node>*/])) > 0)
    {
...
{
    return FocusPrediction::Predict(visual, uDelegate::New(::TYPES[16/*Uno.Predicate<Fuse.Node>*/], (void*)FocusPrediction__PredictFilter__Filter_fn, FocusPrediction__PredictFilter::New1(visual, filter)), uDelegate::New(::TYPES[17/*Uno.Func<Fuse.Visual, Fuse.Visual>*/], (void*)FocusPrediction__FirstVisualChild_fn), uDelegate::New(::TYPES[17/*Uno.Func<Fuse.Visual, Fuse.Visual>*/], (void*)FocusPrediction__NextSibling_fn));
}
...
{
    return FocusPrediction::Predict(visual, uDelegate::New(::TYPES[16/*Uno.Predicate<Fuse.Node>*/], (void*)FocusPrediction__PredictFilter__Filter_fn, FocusPrediction__PredictFilter::New1(visual, filter)), uDelegate::New(::TYPES[17/*Uno.Func<Fuse.Visual, Fuse.Visual>*/], (void*)FocusPrediction__LastVisualChild_fn), uDelegate::New(::TYPES[17/*Uno.Func<Fuse.Visual, Fuse.Visual>*/], (void*)FocusPrediction__PreviousSibling_fn));
}
...
::g::Fuse::Visual* FocusPrediction::PreviousSibling1(::g::Fuse::Visual* parent, ::g::Fuse::Visual* child)
{
    int ret8;
    ::g::Fuse::Node* ret9;
    int offset = (::g::Uno::Collections::EnumerableExtensions__IndexOf_fn(::TYPES[15/*Uno.Collections.EnumerableExtensions.IndexOf<Fuse.Node>*/], uPtr(parent)->Children(), child, &ret8), ret8) - 1;

    if (offset >= 0)

        for (int i = offset; i >= 0; i--)
        {
            ::g::Fuse::Visual* c = uAs< ::g::Fuse::Visual*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(uPtr(parent)->Children()), ::TYPES[14/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret9), ret9), ::TYPES[2/*Fuse.Visual*/]);
...
::g::Fuse::Visual* FocusPredictStrategy::Predict(::g::Fuse::Visual* n, int direction)
{
    ...
    {
        if (direction == 1)
            return ::g::Fuse::Input::FocusPrediction::PredictNextVisual(n, uDelegate::New(::TYPES[16/*Uno.Predicate<Fuse.Node>*/], (void*)::g::Fuse::Input::Focus__CanSetFocus_fn));
        else if (direction == 0)
            return ::g::Fuse::Input::FocusPrediction::PredictPreviousVisual(n, uDelegate::New(::TYPES[16/*Uno.Predicate<Fuse.Node>*/], (void*)::g::Fuse::Input::Focus__CanSetFocus_fn));
    }
...
{
    ::TYPES[19] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Platform::Key_typeof());
    ::TYPES[18] = ::g::Uno::Int_typeof();
    ::TYPES[20] = ::g::Fuse::VisualEvent_typeof()->MakeType(::g::Fuse::Input::KeyPressedHandler_typeof(), ::g::Fuse::Input::KeyPressedArgs_typeof());
    ::TYPES[21] = ::g::Fuse::VisualEvent_typeof()->MakeType(::g::Fuse::Input::KeyReleasedHandler_typeof(), ::g::Fuse::Input::KeyReleasedArgs_typeof());
    type->SetFields(0,
...
static void Pointer__cctor__fn(uType* __type)
{
    ...
    Pointer::_softCapturers_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[23/*Uno.Collections.Dictionary<int, Uno.Collections.IList<Fuse.Input.Capturer>>*/]));
    Pointer::_hardCapturers_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[24/*Uno.Collections.Dictionary<int, Fuse.Input.Capturer>*/]));
    Pointer::_lastHitVisuals_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[25/*Uno.Collections.Dictionary<int, Uno.Collections.List<Fuse.Input.Pointer.PELHolder>>*/]));
...
static void Pointer_build(uType* type)
{
    ...
    ::STRINGS[10] = uString::Const("/usr/local/share/uno/Packages/FuseCore/0.32.14/Input/$.uno");
    ...
    ::TYPES[22] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Int_typeof(), Pointer__PointerRecord_typeof());
    ::TYPES[23] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Int_typeof(), ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Input::Capturer_typeof()));
    ::TYPES[24] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Int_typeof(), ::g::Fuse::Input::Capturer_typeof());
    ::TYPES[25] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Int_typeof(), ::g::Uno::Collections::List_typeof()->MakeType(Pointer__PELHolder_typeof()));
    ::TYPES[26] = ::g::Fuse::Input::IPointerEventResponder_typeof();
    ::TYPES[27] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Visual_typeof());
    ::TYPES[28] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Visual_typeof());
    ::TYPES[29] = ::g::Uno::Collections::List_typeof()->MakeType(Pointer__PELHolder_typeof());
    ::TYPES[30] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Input::Capturer_typeof());
    ::TYPES[31] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Fuse::Input::Capturer_typeof());
    ::TYPES[32] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Input::Capturer_typeof());
    ::TYPES[33] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Input::Capturer_typeof());
    ::TYPES[0] = ::g::Uno::Delegate_typeof();
    ::TYPES[34] = ::g::Uno::Collections::Dictionary__Enumerator_typeof()->MakeType(::g::Uno::Int_typeof(), Pointer__PointerRecord_typeof());
    ::TYPES[35] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::Int_typeof(), Pointer__PointerRecord_typeof());
    ::TYPES[7] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[36] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Input::Capturer_typeof());
    ::TYPES[2] = ::g::Fuse::Visual_typeof();
    ::TYPES[18] = ::g::Uno::Int_typeof();
    ::TYPES[37] = ::g::Uno::Collections::Dictionary__Enumerator_typeof()->MakeType(::g::Uno::Int_typeof(), ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Input::Capturer_typeof()));
    ::TYPES[38] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::Int_typeof(), ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Input::Capturer_typeof()));
    ::TYPES[39] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Int_typeof());
    ::TYPES[40] = ::g::Uno::Collections::Dictionary__Enumerator_typeof()->MakeType(::g::Uno::Int_typeof(), ::g::Fuse::Input::Capturer_typeof());
    ::TYPES[41] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::Int_typeof(), ::g::Fuse::Input::Capturer_typeof());
    ::TYPES[42] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Uno::Int_typeof());
    ::TYPES[43] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Input::Capturer_typeof());
    ::TYPES[44] = ::g::Fuse::VisualEvent_typeof()->MakeType(::g::Fuse::Input::PointerEnteredHandler_typeof(), ::g::Fuse::Input::PointerEnteredArgs_typeof());
    ::TYPES[45] = ::g::Fuse::VisualEvent_typeof()->MakeType(::g::Fuse::Input::PointerLeftHandler_typeof(), ::g::Fuse::Input::PointerLeftArgs_typeof());
    ::TYPES[46] = ::g::Fuse::VisualEvent_typeof()->MakeType(::g::Fuse::Input::PointerMovedHandler_typeof(), ::g::Fuse::Input::PointerMovedArgs_typeof());
    ::TYPES[47] = ::g::Fuse::VisualEvent_typeof()->MakeType(::g::Fuse::Input::PointerPressedHandler_typeof(), ::g::Fuse::Input::PointerPressedArgs_typeof());
    ::TYPES[48] = ::g::Fuse::VisualEvent_typeof()->MakeType(::g::Fuse::Input::PointerReleasedHandler_typeof(), ::g::Fuse::Input::PointerReleasedArgs_typeof());
    type->SetFields(0,
...
void Pointer::CheckFocus(::g::Fuse::Input::PointerPressedArgs* args, uObject* nodes)
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(nodes), ::TYPES[27/*Uno.Collections.ICollection<Fuse.Visual>*/])); ++i)
        if (::g::Fuse::Input::Focus::HandlesFocusEvent((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(nodes), ::TYPES[28/*Uno.Collections.IList<Fuse.Visual>*/]), uCRef<int>(i), &ret8), ret8)))
        {
            b = true;
            break;
        }
...
::g::Uno::Collections::List* Pointer::GetLastHitList(int pointIndex)
{
    ...
    {
        lastHitList = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[29/*Uno.Collections.List<Fuse.Input.Pointer.PELHolder>*/]);
...
::g::Fuse::Input::Capturer* Pointer::GetSoftCapturer(int pointIndex)
{
    ...
    if ((::g::Uno::Collections::Dictionary__ContainsKey_fn(uPtr(Pointer::_softCapturers()), uCRef<int>(pointIndex), &ret13), ret13))
    {
        ...
        while (::g::Uno::Collections::ICollection::Count(uInterface(uPtr(list), ::TYPES[30/*Uno.Collections.ICollection<Fuse.Input.Capturer>*/])) > 0)
        {
            ::g::Fuse::Input::Capturer* n = (::g::Uno::Collections::EnumerableExtensions__First_fn(::TYPES[31/*Uno.Collections.EnumerableExtensions.First<Fuse.Input.Capturer>*/], list, &ret15), ret15);

            if (uPtr(n)->IsSuitable())
                return n;

            ::g::Uno::Collections::IList::RemoveAt(uInterface(uPtr(list), ::TYPES[33/*Uno.Collections.IList<Fuse.Input.Capturer>*/]), 0);
...
bool Pointer::HardCapture(int pointIndex, ::g::Fuse::Visual* node, uObject* identity, uDelegate* lostCallback)
{
    ...
    if ((::g::Uno::Collections::Dictionary__ContainsKey_fn(uPtr(Pointer::_softCapturers()), uCRef<int>(pointIndex), &ret16), ret16))
    {
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(sc), ::TYPES[30/*Uno.Collections.ICollection<Fuse.Input.Capturer>*/])); i++)
        {
            if (uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(sc), ::TYPES[33/*Uno.Collections.IList<Fuse.Input.Capturer>*/]), uCRef<int>(i), &ret18), ret18))->Identity() == identity)
                continue;

            if (::g::Uno::Delegate::op_Inequality(uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(sc), ::TYPES[33/*Uno.Collections.IList<Fuse.Input.Capturer>*/]), uCRef<int>(i), &ret19), ret19))->LostCallback(), NULL))
                uPtr(uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(sc), ::TYPES[33/*Uno.Collections.IList<Fuse.Input.Capturer>*/]), uCRef<int>(i), &ret20), ret20))->LostCallback())->InvokeVoid();
        }

        ::g::Uno::Collections::ICollection::Clear(uInterface(uPtr(sc), ::TYPES[30/*Uno.Collections.ICollection<Fuse.Input.Capturer>*/]));
    }
...
bool Pointer::IsPressed1(int pointIndex)
{
    ...
    for (::g::Uno::Collections::Dictionary__Enumerator<int, uStrong<Pointer__PointerRecord*> > enum2 = (::g::Uno::Collections::Dictionary__GetEnumerator_fn(uPtr(Pointer::_pointersDown()), &ret22), ret22); enum2.MoveNext(::TYPES[34/*Uno.Collections.Dictionary<int, Fuse.Input.Pointer.PointerRecord>.Enumerator*/]); )
    {
        ::g::Uno::Collections::KeyValuePair<int, uStrong<Pointer__PointerRecord*> > p = enum2.Current(::TYPES[34/*Uno.Collections.Dictionary<int, Fuse.Input.Pointer.PointerRecord>.Enumerator*/]);

        if (p.Key(::TYPES[35/*Uno.Collections.KeyValuePair<int, Fuse.Input.Pointer.PointerRecord>*/]) == pointIndex)
            return true;
    }
...
bool Pointer::IsSoftCaptured1(int pointIndex, uObject* capturerIdentity)
{
    ...
    if ((::g::Uno::Collections::Dictionary__ContainsKey_fn(uPtr(Pointer::_softCapturers()), uCRef<int>(pointIndex), &ret24), ret24))
    {
        ...
        for (uObject* enum3 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(sc), ::TYPES[32/*Uno.Collections.IEnumerable<Fuse.Input.Capturer>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum3), ::TYPES[7/*Uno.Collections.IEnumerator*/])); )
        {
            ::g::Fuse::Input::Capturer* s = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum3), ::TYPES[36/*Uno.Collections.IEnumerator<Fuse.Input.Capturer>*/]), &ret26), ret26);
...
::g::Fuse::Input::PointerMovedArgs* Pointer::RaiseMoved(::g::Fuse::Visual* root, ::g::Fuse::Input::PointerEventData* data)
{
    ...
    ::g::Fuse::Input::IPointerEventResponder::OnPointerMoved(uInterface(uPtr(Pointer::EventResponder()), ::TYPES[26/*Fuse.Input.IPointerEventResponder*/]), e);
    return e;
}
...
::g::Fuse::Input::PointerPressedArgs* Pointer::RaisePressed(::g::Fuse::Visual* root, ::g::Fuse::Input::PointerEventData* data)
{
    ...
    ::g::Fuse::Input::IPointerEventResponder::OnPointerPressed(uInterface(uPtr(Pointer::EventResponder()), ::TYPES[26/*Fuse.Input.IPointerEventResponder*/]), e);
    return e;
}
...
::g::Fuse::Input::PointerReleasedArgs* Pointer::RaiseReleased(::g::Fuse::Visual* root, ::g::Fuse::Input::PointerEventData* data)
{
    ...
    ::g::Fuse::Input::IPointerEventResponder::OnPointerReleased(uInterface(uPtr(Pointer::EventResponder()), ::TYPES[26/*Fuse.Input.IPointerEventResponder*/]), e);
...
void Pointer::ReleaseAllCaptures(uObject* identity)
{
    ...
    for (::g::Uno::Collections::Dictionary__Enumerator<int, uStrong<uObject*> > enum4 = (::g::Uno::Collections::Dictionary__GetEnumerator_fn(uPtr(Pointer::_softCapturers()), &ret34), ret34); enum4.MoveNext(::TYPES[37/*Uno.Collections.Dictionary<int, Uno.Collections.IList<Fuse.Input.Capturer>>.Enumerator*/]); )
    {
        ::g::Uno::Collections::KeyValuePair<int, uStrong<uObject*> > sc = enum4.Current(::TYPES[37/*Uno.Collections.Dictionary<int, Uno.Collections.IList<Fuse.Input.Capturer>>.Enumerator*/]);

        for (int i = ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(sc.Value(::TYPES[38/*Uno.Collections.KeyValuePair<int, Uno.Collections.IList<Fuse.Input.Capturer>>*/])), ::TYPES[30/*Uno.Collections.ICollection<Fuse.Input.Capturer>*/])) - 1; i >= 0; --i)
            if (uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(sc.Value(::TYPES[38/*Uno.Collections.KeyValuePair<int, Uno.Collections.IList<Fuse.Input.Capturer>>*/])), ::TYPES[33/*Uno.Collections.IList<Fuse.Input.Capturer>*/]), uCRef<int>(i), &ret35), ret35))->Identity() == identity)
                ::g::Uno::Collections::IList::RemoveAt(uInterface(uPtr(sc.Value(::TYPES[38/*Uno.Collections.KeyValuePair<int, Uno.Collections.IList<Fuse.Input.Capturer>>*/])), ::TYPES[33/*Uno.Collections.IList<Fuse.Input.Capturer>*/]), i);
    }

    ::g::Uno::Collections::List* remove = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[39/*Uno.Collections.List<int>*/]);

    for (::g::Uno::Collections::Dictionary__Enumerator<int, uStrong< ::g::Fuse::Input::Capturer*> > enum5 = (::g::Uno::Collections::Dictionary__GetEnumerator_fn(uPtr(Pointer::_hardCapturers()), &ret36), ret36); enum5.MoveNext(::TYPES[40/*Uno.Collections.Dictionary<int, Fuse.Input.Capturer>.Enumerator*/]); )
    {
        ::g::Uno::Collections::KeyValuePair<int, uStrong< ::g::Fuse::Input::Capturer*> > hc = enum5.Current(::TYPES[40/*Uno.Collections.Dictionary<int, Fuse.Input.Capturer>.Enumerator*/]);

        if (uPtr(hc.Value(::TYPES[41/*Uno.Collections.KeyValuePair<int, Fuse.Input.Capturer>*/]))->Identity() == identity)
            ::g::Uno::Collections::List__Add_fn(uPtr(remove), uCRef<int>(hc.Key(::TYPES[41/*Uno.Collections.KeyValuePair<int, Fuse.Input.Capturer>*/])));
    }

    for (::g::Uno::Collections::List__Enumerator<int> enum6 = (::g::Uno::Collections::List__GetEnumerator_fn(remove, &ret37), ret37); enum6.MoveNext(::TYPES[42/*Uno.Collections.List<int>.Enumerator*/]); )
    {
        int r = enum6.Current(::TYPES[42/*Uno.Collections.List<int>.Enumerator*/]);
...
void Pointer::ReleaseSoftCapture(int pointIndex, uObject* identity)
{
    ...
    if ((::g::Uno::Collections::Dictionary__ContainsKey_fn(uPtr(Pointer::_softCapturers()), uCRef<int>(pointIndex), &ret41), ret41))
    {
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(sc), ::TYPES[30/*Uno.Collections.ICollection<Fuse.Input.Capturer>*/])); i++)
            if (uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(sc), ::TYPES[33/*Uno.Collections.IList<Fuse.Input.Capturer>*/]), uCRef<int>(i), &ret43), ret43))->Identity() == identity)
                ::g::Uno::Collections::IList::RemoveAt(uInterface(uPtr(sc), ::TYPES[33/*Uno.Collections.IList<Fuse.Input.Capturer>*/]), i--);
    }
}
...
bool Pointer::SoftCapture(int pointIndex, ::g::Fuse::Visual* softCapturer, uObject* identity, uDelegate* lostCallback)
{
    ...
    if (!(::g::Uno::Collections::Dictionary__ContainsKey_fn(uPtr(Pointer::_softCapturers()), uCRef<int>(pointIndex), &ret44), ret44))
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(Pointer::_softCapturers()), uCRef<int>(pointIndex), (uObject*)((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[43/*Uno.Collections.List<Fuse.Input.Capturer>*/])));

    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr((::g::Uno::Collections::Dictionary__get_Item_fn(uPtr(Pointer::_softCapturers()), uCRef<int>(pointIndex), &ret45), ret45)), ::TYPES[30/*Uno.Collections.ICollection<Fuse.Input.Capturer>*/]), ::g::Fuse::Input::Capturer::New1(softCapturer, identity, lostCallback));
    return true;
}
...
{
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(uPtr(s), ::TYPES[49/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[15/*"x"*/], (double)__this->WindowPoint().X);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(s, ::TYPES[49/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[16/*"y"*/], (double)__this->WindowPoint().Y);
    ::g::Fuse::Scripting::IEventSerializer::AddInt(uInterface(s, ::TYPES[49/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[17/*"index"*/], __this->PointIndex());
}
...
{
    ::TYPES[50] = ::g::Fuse::HitTestCallback_typeof();
    type->SetFields(0,
...
{
    ::g::Fuse::HitTestContext* args = ::g::Fuse::HitTestContext::New1(point, uDelegate::New(::TYPES[50/*Fuse.HitTestCallback*/], (void*)SelectionQuery__Select_fn, this));
