...
static void RaiseUserEvent_build(uType* type)
{
    ...
    ::STRINGS[4] = uString::Const("/usr/local/share/uno/Packages/Fuse.UserEvents/0.32.14/$.uno");
...
void RaiseUserEvent__Perform_fn(RaiseUserEvent* __this, ::g::Fuse::Node* target)
{
    ...
    if (__this->_event == NULL)
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[3/*"no UserEven...*/], ::g::Uno::UX::Selector__op_Implicit1(__this->EventName())), __this, ::STRINGS[4/*"/usr/local/...*/], 194, ::STRINGS[5/*"Perform"*/]);
    else
