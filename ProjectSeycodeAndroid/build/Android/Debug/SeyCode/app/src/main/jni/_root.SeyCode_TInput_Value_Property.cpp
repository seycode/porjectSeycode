...
// {
static void SeyCode_TInput_Value_Property_build(uType* type)
{
    ::TYPES[0] = ::g::Uno::UX::PropertyObject_typeof();
    type->SetFields(1,
        ::g::TInput_typeof(), offsetof(::g::SeyCode_TInput_Value_Property, _obj), 0);
}
...
::g::Uno::UX::Property1_type* SeyCode_TInput_Value_Property_typeof()
{
    ...
    options.ObjectSize = sizeof(SeyCode_TInput_Value_Property);
    options.TypeSize = sizeof(::g::Uno::UX::Property1_type);
    type = (::g::Uno::UX::Property1_type*)uClassType::New("SeyCode_TInput_Value_Property", options);
    type->SetBase(::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof()));
    type->fp_build_ = SeyCode_TInput_Value_Property_build;
    type->fp_Get = (void(*)(::g::Uno::UX::Property1*, uTRef))SeyCode_TInput_Value_Property__Get_fn;
    type->fp_get_Object = (void(*)(::g::Uno::UX::Property*, ::g::Uno::UX::PropertyObject**))SeyCode_TInput_Value_Property__get_Object_fn;
    type->fp_Set = (void(*)(::g::Uno::UX::Property1*, void*, uObject*))SeyCode_TInput_Value_Property__Set_fn;
    type->fp_get_SupportsOriginSetter = (void(*)(::g::Uno::UX::Property*, bool*))SeyCode_TInput_Value_Property__get_SupportsOriginSetter_fn;
    return type;
}

// public SeyCode_TInput_Value_Property(TInput obj, Uno.UX.Selector name) :13
...
// public SeyCode_TInput_Value_Property New(TInput obj, Uno.UX.Selector name) :13
void SeyCode_TInput_Value_Property__New1_fn(::g::TInput* obj, ::g::Uno::UX::Selector* name, SeyCode_TInput_Value_Property** __retval)
{
    *__retval = SeyCode_TInput_Value_Property::New1(obj, *name);
}
...
// public SeyCode_TInput_Value_Property(TInput obj, Uno.UX.Selector name) [instance] :13
void SeyCode_TInput_Value_Property::ctor_2(::g::TInput* obj, ::g::Uno::UX::Selector name)
{
    ctor_1(name);
    _obj = obj;
}

// public SeyCode_TInput_Value_Property New(TInput obj, Uno.UX.Selector name) [static] :13
SeyCode_TInput_Value_Property* SeyCode_TInput_Value_Property::New1(::g::TInput* obj, ::g::Uno::UX::Selector name)
{
    SeyCode_TInput_Value_Property* obj1 = (SeyCode_TInput_Value_Property*)uNew(SeyCode_TInput_Value_Property_typeof());
