...
{
    ::STRINGS[3] = uString::Const("/usr/local/share/uno/Packages/Fuse.Reactive/0.32.14/FuseJS/$.uno");
...
uObject* Console::Dir(uArray* args)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(builder->ToString(), 1, ::STRINGS[3/*"/usr/local/...*/], 103);
    return NULL;
}
...
{
    for (int i = 0; i < uPtr(args)->Length(); i++)
        ::g::Uno::Diagnostics::Debug::Log5((uPtr(args)->Strong<uObject*>(i) != NULL) ? (uString*)::g::Uno::Object::ToString(uPtr(uPtr(args)->Strong<uObject*>(i))) : ::STRINGS[4/*"null"*/], 1, ::STRINGS[3/*"/usr/local/...*/], 89);
...
static void DataBinding_build(uType* type)
{
    ...
    ::STRINGS[21] = uString::Const("/usr/local/share/uno/Packages/Fuse.Reactive/0.32.14/$.uno");
...
void DataBinding::TryPushAsMarshalledValue(uObject* newValue)
{
    ...
    if ((::g::Fuse::Scripting::Marshal__TryConvertTo1_fn(__types[1], newValue, &value, &ret3), ret3))
    {
        ...
        catch (const uThrowable& __t)
        {
            ...
            ::g::Fuse::Diagnostics::UserError(uPtr(e)->ToString(), Target(), ::STRINGS[21/*"/usr/local/...*/], 413, ::STRINGS[22/*"TryPushAsMa...*/]);
        }
    }
}
...
{
    for (int i = 0; i < uPtr(args)->Length(); i++)
        ::g::Uno::Diagnostics::Debug::Log5((uPtr(args)->Strong<uObject*>(i) != NULL) ? (uString*)::g::Uno::Object::ToString(uPtr(uPtr(args)->Strong<uObject*>(i))) : ::STRINGS[4/*"null"*/], 1, ::STRINGS[3/*"/usr/local/...*/], 67);
...
void JavaScript::EvaluateModule()
{
...

    {
        ...
        if (newModuleResult->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[25/*"JavaScript ...*/], FileName()), ::STRINGS[26/*" fixed!"*/]), this, ::STRINGS[21/*"/usr/local/...*/], 1350, ::STRINGS[27/*"EvaluateMod...*/]);
        ...
        else
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[25/*"JavaScript ...*/], uPtr(se)->FileName()), ::STRINGS[28/*" line "*/]), uBox<int>(::TYPES[13/*int*/], uPtr(se)->LineNumber())), ::STRINGS[29/*". "*/]), uPtr(se)->ErrorMessage()), this, ::STRINGS[21/*"/usr/local/...*/], 1361, ::STRINGS[27/*"EvaluateMod...*/]);
...
void ThreadWorker::CheckAndThrow()
{
    ...
    {
        if (prev != NULL)
            ::g::Fuse::Diagnostics::UnknownException(::STRINGS[50/*"Skipped Exc...*/], next, this, ::STRINGS[21/*"/usr/local/...*/], 2613, ::STRINGS[51/*"CheckAndThrow"*/]);
...
::g::Fuse::Reactive::ValueMirror* ThreadWorker::CreateMirror(uObject* obj)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserWarning(::STRINGS[52/*"JavaScript ...*/], this, ::STRINGS[21/*"/usr/local/...*/], 2778, ::STRINGS[53/*"CreateMirror"*/]);
        return NULL;
    }
...
void ThreadWorker::Run()
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Fuse::Diagnostics::UnknownException(::STRINGS[62/*"ThreadWorke...*/], e, this, ::STRINGS[21/*"/usr/local/...*/], 2501, ::STRINGS[63/*"Run"*/]);
