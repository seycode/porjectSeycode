...
public class XliCppThreadHandler extends Handler {
	...
	private void handleRepeating(Message msg)
	{
		if (msg.arg1 == xliCallbackIndex) {
            com.apps.seycode.ActivityNativeEntryPoints.cppTimerCallback(msg.arg1); // {TODO} this should own callback
			...
			com.apps.seycode.ActivityNativeEntryPoints.cppTimerCallback(msg.arg1);
