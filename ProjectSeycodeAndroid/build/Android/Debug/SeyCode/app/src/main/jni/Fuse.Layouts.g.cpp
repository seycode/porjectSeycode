...
// /usr/local/share/uno/Packages/Fuse.Controls.Panels/0.32.14/Layouts/$.uno
// ------------------------------------------------------------------------
...
static void DefinitionBase_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Panels/0.32.14/Layouts/$.uno");
    ::TYPES[9] = ::g::Uno::Delegate_typeof();
    ::TYPES[10] = ::g::Uno::Collections::List_typeof()->MakeType(DefinitionBase__ParseDataItem_typeof());
    ::TYPES[11] = ::g::Uno::Char_typeof()->Array();
    ::TYPES[12] = ::g::Uno::Collections::IList_typeof()->MakeType(DefinitionBase__ParseDataItem_typeof());
...
{
    Changed1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Changed1, value), ::TYPES[14/*Uno.Action*/]);
}

// internal generated void remove_Changed(Uno.Action value) [instance] :782
void DefinitionBase::remove_Changed(uDelegate* value)
{
    Changed1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Changed1, value), ::TYPES[14/*Uno.Action*/]);
}
...
{
    ::g::Uno::Collections::List* output = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[10/*Uno.Collections.List<Fuse.Layouts.DefinitionBase.ParseDataItem>*/]);
    uArray* s = ::g::Uno::String::Split(uPtr(data), uArray::Init<int>(::TYPES[11/*char[]*/], 1, ','));
...
DefinitionBase__ParseDataItem DefinitionBase::ParseDataSingle(uString* data)
{
    ...
    catch (const uThrowable& __t)
    {
        ...
        ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::STRINGS[1/*"Unable to p...*/], data), 1, ::STRINGS[2/*"/usr/local/...*/], 839);
...
static void DockLayout_build(uType* type)
{
    ...
    ::TYPES[3] = ::g::Fuse::Node_typeof();
    ::TYPES[4] = ::g::Uno::Int_typeof();
    ::TYPES[15] = ::g::Fuse::Layouts::Dock_typeof();
...
int DockLayout::GetDock(::g::Fuse::Visual* elm)
{
    ...
    if (uPtr(uPtr(elm)->Properties())->TryGet(DockLayout::_dockProperty(), &val))
        return uUnbox<int>(::TYPES[15/*Fuse.Layouts.Dock*/], val);
...
{
    DockLayout_typeof()->Init();
    uPtr(uPtr(elm)->Properties())->Set(DockLayout::_dockProperty(), uBox<int>(::TYPES[15/*Fuse.Layouts.Dock*/], dock));
...
{
    ::TYPES[17] = ::g::Uno::Collections::ObservableList_typeof()->MakeType(::g::Fuse::Layouts::Row_typeof());
    ::TYPES[18] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Layouts::Row_typeof());
    ::TYPES[19] = ::g::Uno::Collections::ObservableList_typeof()->MakeType(::g::Fuse::Layouts::Column_typeof());
    ::TYPES[20] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Layouts::Column_typeof());
    ::TYPES[0] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
    ::TYPES[2] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[3] = ::g::Fuse::Node_typeof();
    ::TYPES[14] = ::g::Uno::Action_typeof();
    ::TYPES[4] = ::g::Uno::Int_typeof();
    ::TYPES[21] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Layouts::Column_typeof());
    ::TYPES[22] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Int_typeof());
    ::TYPES[16] = uObject_typeof();
    ::TYPES[23] = ::g::Uno::Collections::IListExtensions_typeof()->MakeMethod(1, ::g::Fuse::Layouts::Column_typeof());
    ::TYPES[24] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Layouts::Column_typeof());
    ::TYPES[25] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Layouts::Row_typeof());
    ::TYPES[26] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Layouts::Row_typeof());
    type->SetFields(2,
...
void GridLayout::ctor_2()
{
    ...
    _cellSpacing = 0.0f;
    ctor_1();
    _rows = ((::g::Uno::Collections::ObservableList*)::g::Uno::Collections::ObservableList::New1(::TYPES[17/*Uno.Collections.ObservableList<Fuse.Layouts.Row>*/], uDelegate::New(::TYPES[18/*Uno.Action<Fuse.Layouts.Row>*/], (void*)GridLayout__RowAdded_fn, this), uDelegate::New(::TYPES[18/*Uno.Action<Fuse.Layouts.Row>*/], (void*)GridLayout__RowRemoved_fn, this)));
    _columns = ((::g::Uno::Collections::ObservableList*)::g::Uno::Collections::ObservableList::New1(::TYPES[19/*Uno.Collections.ObservableList<Fuse.Layouts.Column>*/], uDelegate::New(::TYPES[20/*Uno.Action<Fuse.Layouts.Column>*/], (void*)GridLayout__ColumnAdded_fn, this), uDelegate::New(::TYPES[20/*Uno.Action<Fuse.Layouts.Column>*/], (void*)GridLayout__ColumnRemoved_fn, this)));
}
...
void GridLayout::ColumnAdded(::g::Fuse::Layouts::Column* c)
{
    ...
    uPtr(c)->add_Changed(uDelegate::New(::TYPES[14/*Uno.Action*/], (void*)GridLayout__Changed_fn, this));
    Changed();
}
...
{
    return ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(ColumnList()), ::TYPES[21/*Uno.Collections.ICollection<Fuse.Layouts.Column>*/]));
}
...
void GridLayout::ColumnCount(int value)
{
    ...
    while (::g::Uno::Collections::ICollection::Count(uInterface(uPtr(ColumnList()), ::TYPES[21/*Uno.Collections.ICollection<Fuse.Layouts.Column>*/])) < value)
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(ColumnList()), ::TYPES[21/*Uno.Collections.ICollection<Fuse.Layouts.Column>*/]), GenDefaultColumn());

    while (::g::Uno::Collections::ICollection::Count(uInterface(uPtr(ColumnList()), ::TYPES[21/*Uno.Collections.ICollection<Fuse.Layouts.Column>*/])) > value)
        ::g::Uno::Collections::IListExtensions__RemoveLast_fn(::TYPES[23/*Uno.Collections.IListExtensions.RemoveLast<Fuse.Layouts.Column>*/], ColumnList(), &ret28);
...
void GridLayout::ColumnRemoved(::g::Fuse::Layouts::Column* c)
{
    ...
    uPtr(c)->remove_Changed(uDelegate::New(::TYPES[14/*Uno.Action*/], (void*)GridLayout__Changed_fn, this));
    Changed();
}
...
void GridLayout::GetActualPositions(uObject* elements)
{
    ...
    int columnCount = ::g::Uno::Math::Max8(1, ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(ColumnList()), ::TYPES[21/*Uno.Collections.ICollection<Fuse.Layouts.Column>*/])));
    ...
    ::g::Uno::Collections::List* rowAvail = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New2(::TYPES[22/*Uno.Collections.List<int>*/], columnCount);
...
void GridLayout::RowAdded(::g::Fuse::Layouts::Row* r)
{
    ...
    uPtr(r)->add_Changed(uDelegate::New(::TYPES[14/*Uno.Action*/], (void*)GridLayout__Changed_fn, this));
    Changed();
}
...
void GridLayout::RowRemoved(::g::Fuse::Layouts::Row* r)
{
    ...
    uPtr(r)->remove_Changed(uDelegate::New(::TYPES[14/*Uno.Action*/], (void*)GridLayout__Changed_fn, this));
    Changed();
}
...
{
    ::g::Uno::Collections::ICollection::Clear(uInterface(uPtr(RowList()), ::TYPES[26/*Uno.Collections.ICollection<Fuse.Layouts.Row>*/]));
...
bool Layout::GetFillPadding(::g::Fuse::Visual* n)
{
    ...
    if (uPtr(uPtr(n)->Properties())->TryGet(Layout::_fillPaddingProperty(), &v))
        return uUnbox<bool>(::TYPES[28/*bool*/], v);
...
{
    ::TYPES[29] = ::g::Fuse::Layouts::Layout_typeof();
    type->SetFields(0,
...
static void Row_build(uType* type)
{
    ...
    ::TYPES[30] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Layouts::DefinitionBase__ParseDataItem_typeof());
    ::TYPES[6] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[31] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Layouts::DefinitionBase__ParseDataItem_typeof());
    ::TYPES[26] = ::g::Uno::Collections::ICollection_typeof()->MakeType(Row_typeof());
    ::TYPES[16] = uObject_typeof();
    ::TYPES[32] = ::g::Uno::Float_typeof();
    ::TYPES[25] = ::g::Uno::Collections::IList_typeof()->MakeType(Row_typeof());
    ::TYPES[4] = ::g::Uno::Int_typeof();
    type->SetFields(4,
...
uString* Row::Serialize()
{
    switch (HeightMetric())
    {
        ...
        case 1:
            return ::g::Uno::String::op_Addition(uBox(::TYPES[32/*float*/], Height()), ::STRINGS[5/*"*"*/]);
        default:
            return ::g::Uno::Float::ToString(Height(), ::TYPES[32/*float*/]);
    }
}
...
void Row::Parse1(uString* data, uObject* output)
{
    ...
    for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(::g::Fuse::Layouts::DefinitionBase::ParseData(data)), ::TYPES[30/*Uno.Collections.IEnumerable<Fuse.Layouts.DefinitionBase.ParseDataItem>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[6/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Fuse::Layouts::DefinitionBase__ParseDataItem item = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[31/*Uno.Collections.IEnumerator<Fuse.Layouts.DefinitionBase.ParseDataItem>*/]), &ret7), ret7);
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(output), ::TYPES[26/*Uno.Collections.ICollection<Fuse.Layouts.Row>*/]), Row::New3(item.Value, item.Metric));
    }
}
...
uString* Row::Serialize1(uObject* rows)
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(rows), ::TYPES[26/*Uno.Collections.ICollection<Fuse.Layouts.Row>*/])); i++)
    {
        if (i > 0)
            s = ::g::Uno::String::op_Addition2(s, ::STRINGS[7/*", "*/]);

        s = ::g::Uno::String::op_Addition2(s, uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(rows), ::TYPES[25/*Uno.Collections.IList<Fuse.Layouts.Row>*/]), uCRef<int>(i), &ret8), ret8))->Serialize());
    }
...
void WrapLayout__ArrangePaddingBox_fn(WrapLayout* __this, uObject* elements, ::g::Uno::Float4* padding, ::g::Fuse::LayoutParams* lp)
{
    ...
    uArray* placements = uArray::New(::TYPES[33/*float4[]*/], ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(elements), ::TYPES[0/*Uno.Collections.ICollection<Fuse.Node>*/])));
