...
// /usr/local/share/uno/Packages/Fuse.Elements/0.32.14/$.uno
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.32.14/Caching/$.uno
// -----------------------------------------------------------------
...
static void Cache_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Elements/0.32.14/Caching/$.uno");
...
static void Element_build(uType* type)
{
    ...
    ::STRINGS[8] = uString::Const("/usr/local/share/uno/Packages/Fuse.Elements/0.32.14/$.uno");
...
void Element__Draw_fn(Element* __this, ::g::Fuse::DrawContext* dc)
{
    if (!__this->IsRootingCompleted())
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[9/*"Draw called...*/], __this, ::STRINGS[8/*"/usr/local/...*/], 806, ::STRINGS[10/*"Draw"*/]);
...
::g::Uno::Graphics::Framebuffer* Element::CaptureRegion(::g::Fuse::DrawContext* dc, ::g::Uno::Rect region, ::g::Uno::Float2 padding)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[6/*"CaptureRegi...*/], uBox(::g::Uno::Int2_typeof(), fsz)), ::STRINGS[7/*", max-size: "*/]), uBox<int>(::TYPES[0/*int*/], ::g::Uno::Graphics::Texture2D::MaxSize())), 1, ::STRINGS[8/*"/usr/local/...*/], 782);
        return NULL;
    }
