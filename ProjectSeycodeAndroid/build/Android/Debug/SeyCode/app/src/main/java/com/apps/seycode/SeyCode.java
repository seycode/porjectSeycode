...
public class SeyCode extends android.app.Activity implements ActivityCompat.OnRequestPermissionsResultCallback
{
    ...
    {
    	SeyCode activity = _appState.CurrentActivity;
