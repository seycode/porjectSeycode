...
void ContinuousTrackChangeState__SeekValue_fn(ContinuousTrackChangeState* __this, ::g::Uno::Float4* value, float* strength)
{
    ...
    if (__this->mixHandle == NULL)
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[5/*"Invalid Seek"*/], 1, ::STRINGS[1/*"/usr/local/...*/], 689);
        return;
    }
...
void CycleState__Seek_fn(CycleState* __this, bool* on, float* interval, float* strength, int* dir, bool* __retval)
{
    ...
    if (__this->mixHandle == NULL)
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[6/*"Invalid seek"*/], 1, ::STRINGS[1/*"/usr/local/...*/], 971);
...
void DiscreteTrackChangeState__SeekObjectValue_fn(DiscreteTrackChangeState* __this, uObject* value, float* strength)
{
    ...
    if (__this->mixHandle == NULL)
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[5/*"Invalid Seek"*/], 1, ::STRINGS[1/*"/usr/local/...*/], 656);
        return;
    }
...
void MasterBase::Register(::g::Fuse::Animations::MixerHandle* handle)
{
    ...
    if (_inactive)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[7/*"Attempt to ...*/], this, ::STRINGS[1/*"/usr/local/...*/], 1610, ::STRINGS[8/*"Register"*/]);
        return;
    }
...
void MixerHandle__Set_fn(MixerHandle* __this, void* value, float* strength)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[13/*"invalid Mix...*/], 1, ::STRINGS[1/*"/usr/local/...*/], 1883);
        return;
    }
...
void ResizeAnimatorState::ctor_2(::g::Fuse::Animations::Resize* r, ::g::Fuse::Animations::CreateStateParams* p)
{
    ...
    if (_target == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[15/*"Resize star...*/], r, ::STRINGS[1/*"/usr/local/...*/], 2711, ::STRINGS[16/*".ctor"*/]);
        _valid = false;
        return;
    }
    ...
    if (_relativeTo == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[17/*"Resize star...*/], r, ::STRINGS[1/*"/usr/local/...*/], 2719, ::STRINGS[16/*".ctor"*/]);
        _valid = false;
        return;
    }
...
void SpinState__Seek_fn(SpinState* __this, bool* on, float* interval, float* strength, int* dir, bool* __retval)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[6/*"Invalid seek"*/], 1, ::STRINGS[1/*"/usr/local/...*/], 2868);
        return *__retval = true, void();
    }
...
void TransformAnimatorState__SeekValue_fn(TransformAnimatorState* __this, ::g::Uno::Float4* value, float* strength)
{
    ...
    if ((__this->mixHandle == NULL) || (__this->transform == NULL))
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[6/*"Invalid seek"*/], 1, ::STRINGS[1/*"/usr/local/...*/], 3637);
        return;
    }
