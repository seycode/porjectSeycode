...
jint JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    jclass activityClass = env->FindClass("com/apps/seycode/SeyCode");
    jclass entryPointsClass = env->FindClass("com/apps/seycode/ActivityNativeEntryPoints");
    jclass displayClass = env->FindClass("com/apps/seycode/Display");
