...
// /usr/local/share/uno/Packages/Fuse.Elements/0.32.14/Triggers/Actions/$.uno
// --------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls/0.32.14/Triggers/$.uno
// ------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.WebView/0.32.14/$.uno
// -----------------------------------------------------------------
...
{
    ::g::Fuse::Scripting::IEventSerializer::AddString(uInterface(uPtr(s), ::TYPES[11/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[1/*"json"*/], __this->ResultJson);
}
...
static void RaiseUserEvent_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/usr/local/share/uno/Packages/Fuse.UserEvents/0.32.14/$.uno");
...
void RaiseUserEvent__Perform_fn(RaiseUserEvent* __this, ::g::Fuse::Node* target)
{
    ...
    if (__this->_event == NULL)
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[2/*"no UserEven...*/], ::g::Uno::UX::Selector__op_Implicit1(__this->EventName())), __this, ::STRINGS[3/*"/usr/local/...*/], 194, ::STRINGS[4/*"Perform"*/]);
    else
