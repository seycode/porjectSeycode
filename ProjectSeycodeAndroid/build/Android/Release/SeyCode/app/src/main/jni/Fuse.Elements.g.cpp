...
static void Element_build(uType* type)
{
    ...
    ::STRINGS[7] = uString::Const("/usr/local/share/uno/Packages/Fuse.Elements/0.32.14/$.uno");
...
void Element__Draw_fn(Element* __this, ::g::Fuse::DrawContext* dc)
{
    if (!__this->IsRootingCompleted())
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[6/*"Draw called...*/], __this, ::STRINGS[7/*"/usr/local/...*/], 806, ::STRINGS[8/*"Draw"*/]);
