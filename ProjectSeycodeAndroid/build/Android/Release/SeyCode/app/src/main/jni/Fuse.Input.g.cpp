...
{
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(uPtr(s), ::TYPES[49/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[12/*"x"*/], (double)__this->WindowPoint().X);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(s, ::TYPES[49/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[13/*"y"*/], (double)__this->WindowPoint().Y);
    ::g::Fuse::Scripting::IEventSerializer::AddInt(uInterface(s, ::TYPES[49/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[14/*"index"*/], __this->PointIndex());
}
