...
// /usr/local/share/uno/Packages/UnoCore/0.32.2/Source/Uno/Platform2/$.uno
// -----------------------------------------------------------------------
...
void Application::DispatchDelayedUri()
{
    ...
    if (::g::Uno::Delegate::op_Inequality(handler, NULL))
    {
        ...
        {
            for (::g::Uno::Collections::List__Enumerator<uStrong<uString*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(Application::_delayedURIS()), &ret2), ret2); enum1.MoveNext(::TYPES[2/*Uno.Collections.List<string>.Enumerator*/]); )
            {
                uString* u = enum1.Current(::TYPES[2/*Uno.Collections.List<string>.Enumerator*/]);
...
static void Display_build(uType* type)
{
    ...
    ::TYPES[8] = ::g::Uno::EventHandler1_typeof()->MakeType(::g::Uno::Platform::TimerEventArgs_typeof());
    ::TYPES[6] = ::g::Uno::EventHandler_typeof();
    type->SetFields(0,
...
{
    _tick1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(_tick1, value), ::TYPES[8/*Uno.EventHandler<Uno.Platform.TimerEventArgs>*/]);
}
...
{
    _tick1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(_tick1, value), ::TYPES[8/*Uno.EventHandler<Uno.Platform.TimerEventArgs>*/]);
}
