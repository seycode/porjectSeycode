...
// {
static void SeyCode_Tab_Text_Property_build(uType* type)
{
    ::TYPES[0] = ::g::Uno::UX::PropertyObject_typeof();
    type->SetFields(1,
        ::g::Tab_typeof(), offsetof(::g::SeyCode_Tab_Text_Property, _obj), 0);
}
...
::g::Uno::UX::Property1_type* SeyCode_Tab_Text_Property_typeof()
{
    ...
    options.ObjectSize = sizeof(SeyCode_Tab_Text_Property);
    options.TypeSize = sizeof(::g::Uno::UX::Property1_type);
    type = (::g::Uno::UX::Property1_type*)uClassType::New("SeyCode_Tab_Text_Property", options);
    type->SetBase(::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof()));
    type->fp_build_ = SeyCode_Tab_Text_Property_build;
    type->fp_Get = (void(*)(::g::Uno::UX::Property1*, uTRef))SeyCode_Tab_Text_Property__Get_fn;
    type->fp_get_Object = (void(*)(::g::Uno::UX::Property*, ::g::Uno::UX::PropertyObject**))SeyCode_Tab_Text_Property__get_Object_fn;
    type->fp_Set = (void(*)(::g::Uno::UX::Property1*, void*, uObject*))SeyCode_Tab_Text_Property__Set_fn;
    type->fp_get_SupportsOriginSetter = (void(*)(::g::Uno::UX::Property*, bool*))SeyCode_Tab_Text_Property__get_SupportsOriginSetter_fn;
    return type;
}

// public SeyCode_Tab_Text_Property(Tab obj, Uno.UX.Selector name) :49
...
// public SeyCode_Tab_Text_Property New(Tab obj, Uno.UX.Selector name) :49
void SeyCode_Tab_Text_Property__New1_fn(::g::Tab* obj, ::g::Uno::UX::Selector* name, SeyCode_Tab_Text_Property** __retval)
{
    *__retval = SeyCode_Tab_Text_Property::New1(obj, *name);
}
...
// public SeyCode_Tab_Text_Property(Tab obj, Uno.UX.Selector name) [instance] :49
void SeyCode_Tab_Text_Property::ctor_2(::g::Tab* obj, ::g::Uno::UX::Selector name)
{
    ctor_1(name);
    _obj = obj;
}

// public SeyCode_Tab_Text_Property New(Tab obj, Uno.UX.Selector name) [static] :49
SeyCode_Tab_Text_Property* SeyCode_Tab_Text_Property::New1(::g::Tab* obj, ::g::Uno::UX::Selector name)
{
    SeyCode_Tab_Text_Property* obj1 = (SeyCode_Tab_Text_Property*)uNew(SeyCode_Tab_Text_Property_typeof());
