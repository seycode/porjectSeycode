...
public class TextEditRenderer
{
    ...
    {
        android.widget.GridLayout gridLayout = new android.widget.GridLayout(com.apps.seycode.SeyCode.GetRootActivity());
    ...
    {
        android.widget.TextView tv = new android.widget.TextView(com.apps.seycode.SeyCode.GetRootActivity());
