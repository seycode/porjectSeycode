...
static void Marshal_build(uType* type)
{
    ...
    ::STRINGS[31] = uString::Const(" to a FileSource");
    ::STRINGS[32] = uString::Const("#");
    ::STRINGS[33] = uString::Const(" to float4");
    ::STRINGS[34] = uString::Const("Unable to parse selector value: ");
    ::STRINGS[35] = uString::Const("%");
    ::STRINGS[36] = uString::Const("px");
    ::STRINGS[37] = uString::Const("pt");
    ::STRINGS[38] = uString::Const("Unable to parse size value: ");
    ::STRINGS[39] = uString::Const("Unable to parse size vector: ");
    ::STRINGS[40] = uString::Const("Unable to convert '");
    ::STRINGS[41] = uString::Const("' to type ");
...
void Marshal__ToType_fn(uType* __type, uObject* o, uTRef __retval)
{
    ...
    if ((Marshal__TryConvertTo1_fn(__types[1], o, &value, &ret5), ret5))
        ...
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[40/*"Unable to c...*/], o), ::STRINGS[41/*"' to type "*/]), __types[0])));
}
...
::g::Uno::UX::FileSource* Marshal::ToFileSource(uObject* obj)
{
    ...
    if (uIs(obj, ::TYPES[19/*string*/]))
    {
        ...
        return ::g::Fuse::Scripting::JSFileSource::New1(uAs<uString*>(::g::Fuse::Scripting::IObject::Item(uInterface(uPtr((uObject*)obj), ::TYPES[34/*Fuse.Scripting.IObject*/]), ::STRINGS[30/*"path"*/]), ::TYPES[19/*string*/]));
    else
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[28/*"Unable to c...*/], ::g::Uno::Object::GetType(uPtr(obj))), ::STRINGS[31/*" to a FileS...*/])));
}
...
::g::Uno::Float4 Marshal::ToFloat41(uObject* o)
{
    ...
    if (uIs(o, ::TYPES[19/*string*/]))
    {
        ...
        if (::g::Uno::String::StartsWith(uPtr(s), ::STRINGS[32/*"#"*/]))
            return ::g::Uno::Color::FromHex(s);
    }

    U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[28/*"Unable to c...*/], o), ::STRINGS[33/*" to float4"*/])));
}
...
::g::Uno::UX::Selector Marshal::ToSelector(uObject* o)
{
    ...
    U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::STRINGS[34/*"Unable to p...*/], o)));
}
...
::g::Uno::UX::Size Marshal::ToSize(uObject* o)
{
    ...
    U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::STRINGS[38/*"Unable to p...*/], o)));
}
...
::g::Uno::UX::Size2 Marshal::ToSize2(uObject* o)
{
    ...
    U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::STRINGS[39/*"Unable to p...*/], o)));
}
...
::g::Fuse::Scripting::ModuleResult* Module::Evaluate1(::g::Fuse::Scripting::Context* c, uString* id)
{
    ...
    uPtr(module)->Item(::STRINGS[42/*"exports"*/], c->NewObject());
    ...
    if (::g::Uno::String::op_Inequality(id, NULL))
        uPtr(module)->Item(::STRINGS[43/*"id"*/], id);
...
{
    uObject* r = uPtr(uPtr(Evaluate1(c, id))->Object)->Item(::STRINGS[42/*"exports"*/]);
    return r;
}
// }
...
{
    ::STRINGS[44] = uString::Const("(unknown module)");
...
void ModuleResult__ToString_fn(ModuleResult* __this, uString** __retval)
{
    ...
    return *__retval = ::STRINGS[44/*"(unknown mo...*/], void();
}
...
{
    ::STRINGS[45] = uString::Const("NativeModule(): Cannot add more members after first use");
    ::STRINGS[42] = uString::Const("exports");
...
void NativeModule__Evaluate_fn(NativeModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result)
{
    ...
    ::g::Fuse::Scripting::Object* obj = uAs< ::g::Fuse::Scripting::Object*>(uPtr(module)->Item(::STRINGS[42/*"exports"*/]), ::TYPES[8/*Fuse.Scripting.Object*/]);
...
{
    if (_isEvaluated)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[45/*"NativeModul...*/]));
...
{
    ::STRINGS[46] = uString::Const("require(): accepts exactly one argument, ");
    ::STRINGS[47] = uString::Const(" provided");
    ::STRINGS[48] = uString::Const("require(): argument must be a string");
    ::STRINGS[49] = uString::Const("require(): module not found: ");
    ::STRINGS[50] = uString::Const("JavaScript error in ");
    ::STRINGS[51] = uString::Const(" was fixed!");
    ::STRINGS[52] = uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting/0.32.14/$.uno");
    ::STRINGS[53] = uString::Const("Require");
...
{
    if (uPtr(args)->Length() != 1)
        U_THROW(::g::Fuse::Scripting::Error::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[46/*"require(): ...*/], uBox<int>(::TYPES[22/*int*/], uPtr(args)->Length())), ::STRINGS[47/*" provided"*/])));

    uString* id = uAs<uString*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[19/*string*/]);

    if (::g::Uno::String::op_Equality(id, NULL))
        U_THROW(::g::Fuse::Scripting::Error::New4(::STRINGS[48/*"require(): ...*/]));
...
uObject* ScriptModule__RequireContext::Require1(uString* id)
{
    ...
    if (module == NULL)
    {
        ...
        if (mod == NULL)
            U_THROW(::g::Fuse::Scripting::Error::New4(::g::Uno::String::op_Addition2(::STRINGS[49/*"require(): ...*/], id)));
        ...
        if (module->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[50/*"JavaScript ...*/], path), ::STRINGS[51/*" was fixed!"*/]), this, ::STRINGS[52/*"/usr/local/...*/], 204, ::STRINGS[53/*"Require"*/]);
        ...
        else
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[50/*"JavaScript ...*/], path), ::STRINGS[54/*" line "*/]), uBox<int>(::TYPES[22/*int*/], uPtr(e)->LineNumber())), ::STRINGS[55/*". "*/]), uPtr(e)->ErrorMessage()), this, ::STRINGS[52/*"/usr/local/...*/], 214, ::STRINGS[53/*"Require"*/]);
    ...
    return uPtr(uPtr(module)->Object)->Item(::STRINGS[42/*"exports"*/]);
}
...
static void ScriptException_build(uType* type)
{
    ...
    ::STRINGS[57] = uString::Const("Error message: ");
    ::STRINGS[58] = uString::Const("File name: ");
    ::STRINGS[59] = uString::Const("Line number: ");
    ::STRINGS[60] = uString::Const("Source line: ");
    ::STRINGS[61] = uString::Const("JS stack trace: ");
    ::TYPES[22] = ::g::Uno::Int_typeof();
    type->SetFields(3,
...
void ScriptException__get_Message_fn(ScriptException* __this, uString** __retval)
{
    ...
    {
        uPtr(stringBuilder)->Append2(::STRINGS[60/*"Source line: "*/]);
        stringBuilder->AppendLine(__this->SourceLine());
    }

    if (!::g::Uno::String::IsNullOrEmpty(__this->JSStackTrace()))
    {
        uPtr(stringBuilder)->Append2(::STRINGS[61/*"JS stack tr...*/]);
...
{
    ::STRINGS[62] = uString::Const("Cannot call a non-void method asynchronously");
    ::STRINGS[63] = uString::Const("/usr/local/share/uno/Packages/FuseCore/0.32.14/Scripting/$.uno");
    ::STRINGS[64] = uString::Const("Call");
    ::TYPES[22] = ::g::Uno::Int_typeof();
    ::TYPES[9] = ::g::Uno::Delegate_typeof();
    ::TYPES[1] = uObject_typeof();
    ::TYPES[54] = ::g::Uno::Action_typeof();
...
void ScriptMethod1__Call_fn(ScriptMethod1* __this, uObject* obj, uArray* args, uObject** __retval)
{
    ...
    if (__this->Thread == 2)
    {
        ...
        {
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[62/*"Cannot call...*/], __this, ::STRINGS[63/*"/usr/local/...*/], 129, ::STRINGS[64/*"Call"*/]);
            return *__retval = NULL, void();
        }
...
{
    ScriptModule::ModuleContainsAnErrorMessage_ = ::STRINGS[65/*"require(): ...*/];
}

static void ScriptModule_build(uType* type)
{
    ::STRINGS[65] = uString::Const("require(): module contains an error: ");
    ::STRINGS[66] = uString::Const(".");
    ::STRINGS[67] = uString::Const("/");
    ::STRINGS[3] = uString::Const("");
    ::STRINGS[68] = uString::Const("..");
    ::STRINGS[69] = uString::Const("(function(");
    ::STRINGS[70] = uString::Const(") { ");
    ::STRINGS[71] = uString::Const("\n"
        " })");
    ::STRINGS[72] = uString::Const("Could not evaluate module '");
    ::STRINGS[73] = uString::Const("': JavaScript code contains errors");
    ::STRINGS[42] = uString::Const("exports");
    ::STRINGS[74] = uString::Const("module, exports, require");
    ::STRINGS[75] = uString::Const(".js");
...
void ScriptModule__Evaluate_fn(ScriptModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result)
{
    ...
    uString* wrappedCode = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[69/*"(function("*/], __this->GenerateArgs(c, result, args)), ::STRINGS[70/*") { "*/]), uString::CharArray(newlines)), __this->Code()), ::STRINGS[71/*"\n })"*/]);
    ...
    if (moduleFunc == NULL)
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[72/*"Could not e...*/], __this->FileName()), ::STRINGS[73/*"': JavaScri...*/])));
...
void ScriptModule__GenerateArgs_fn(ScriptModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result, ::g::Uno::Collections::List* args, uString** __retval)
{
    ...
    ::g::Uno::Collections::List__Add_fn(args, uPtr(module)->Item(::STRINGS[42/*"exports"*/]));
    ...
    return *__retval = ::STRINGS[74/*"module, exp...*/], void();
}
...
{
    if (::g::Uno::String::StartsWith(uPtr(moduleId), ::STRINGS[66/*"."*/]))
    {
        *isFile = true;
        return ScriptModule::ComputePath1(GetSourcePath(), moduleId);
    }
    else if (::g::Uno::String::StartsWith(uPtr(moduleId), ::STRINGS[67/*"/"*/]))
    {
        *isFile = true;
...
uString* ScriptModule::ComputePath1(uString* sourcePath, uString* moduleId)
{
    ...
    for (int i = 0; i < uPtr(parts)->Length(); i++)
        if (::g::Uno::String::op_Equality(uPtr(parts)->Strong<uString*>(i), ::STRINGS[3/*""*/]))
            continue;
        else if (::g::Uno::String::op_Equality(uPtr(parts)->Strong<uString*>(i), ::STRINGS[66/*"."*/]))
            continue;
            ...
            sourcePath = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(sourcePath, ::STRINGS[67/*"/"*/]), uPtr(parts)->Strong<uString*>(i));
        else
...
bool ScriptModule::IsPathEqual(uString* src, uString* path)
{
    ...
    if (::g::Uno::String::op_Equality(src, ::g::Uno::String::op_Addition2(path, ::STRINGS[75/*".js"*/])))
        return true;
