...
public final class Activity
{
    ...
    {
        return com.apps.seycode.SeyCode.GetRootActivity();
    }

    // - - - - - - - - - - - - - - - - - - - - - - - -

    public interface LifecycleListener extends com.apps.seycode.ActivityState.AndroidLifecycleListener {}

    public static void subscribeToLifecycleChange(LifecycleListener listener)
	{
        com.apps.seycode.SeyCode activity = (com.apps.seycode.SeyCode)getRootActivity();
