...
void EdgeNavigation__OnRooted_fn(EdgeNavigation* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[5/*"Element"*/], __this->Parent(), __this, ::STRINGS[1/*"/usr/local/...*/], 182, ::STRINGS[6/*"OnRooted"*/]);
...
void NavigatedArgs__FuseScriptingIScriptEventSerialize_fn(NavigatedArgs* __this, uObject* s)
{
    if (::g::Uno::String::op_Inequality(::g::Uno::UX::Selector__op_Implicit1(uPtr(__this->NewVisual())->Name()), NULL))
        ::g::Fuse::Scripting::IEventSerializer::AddString(uInterface(uPtr(s), ::TYPES[14/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[8/*"name"*/], ::g::Uno::UX::Selector__op_Implicit1(uPtr(__this->NewVisual())->Name()));
    else
        ::g::Fuse::Scripting::IEventSerializer::AddString(uInterface(uPtr(s), ::TYPES[14/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[8/*"name"*/], ::STRINGS[9/*""*/]);
}
...
void NavigateToggle__Perform1_fn(NavigateToggle* __this, uObject* ctx, ::g::Fuse::Node* n)
{
    ...
    if (page != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[10/*"No Page was...*/], __this, ::STRINGS[1/*"/usr/local/...*/], 2915, ::STRINGS[2/*"Perform"*/]);
}
...
uObject* Navigation::TryFindBaseNavigation(::g::Fuse::Visual* node)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[11/*"TryFindBase...*/], node, ::STRINGS[1/*"/usr/local/...*/], 902, ::STRINGS[12/*"TryFindBase...*/]);
        return NULL;
    }
...
::g::Fuse::Visual* Navigation::TryFindPage1(::g::Fuse::Visual* node, uObject** nav, ::g::Fuse::Visual** pageBind)
{
    ...
    *pageBind = NULL;
    ...
    if (!uPtr(node)->IsRootingStarted())
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[13/*"TryFindPage...*/], node, ::STRINGS[1/*"/usr/local/...*/], 950, ::STRINGS[14/*"TryFindPage"*/]);
        return NULL;
    }
            ...
            *pageBind = node;
            ...
            if (uPtr(p)->IsRootingStarted())
            {
                *nav = Navigation::TryFind(p);
                ...
                if (*nav == NULL)
                {
                    ::g::Fuse::Diagnostics::UserWarning(::STRINGS[15/*"`Page` set ...*/], p, ::STRINGS[1/*"/usr/local/...*/], 968, ::STRINGS[14/*"TryFindPage"*/]);
                    return NULL;
                }
            }
...
void NavigationPageProxy::OnPageRootingCompleted()
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[16/*"Got an unde...*/], this, ::STRINGS[1/*"/usr/local/...*/], 1092, ::STRINGS[17/*"OnPageRooti...*/]);
        return;
    }
...
void NavigationPageProxy::Rooted(::g::Fuse::Visual* source)
{
    ...
    if (_source == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[18/*"Attempting ...*/], this, ::STRINGS[1/*"/usr/local/...*/], 1058, ::STRINGS[19/*"Rooted"*/]);
        return;
    }
    ...
    if (_navigation == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[20/*"Something w...*/], this, ::STRINGS[1/*"/usr/local/...*/], 1079, ::STRINGS[19/*"Rooted"*/]);
        return;
    }
...
void NavigationTriggerAction__Perform_fn(NavigationTriggerAction* __this, ::g::Fuse::Node* n)
{
    ...
    if (ctx == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[21/*"No navigati...*/], __this, ::STRINGS[1/*"/usr/local/...*/], 2842, ::STRINGS[2/*"Perform"*/]);
        return;
    }
...
{
    ::g::Fuse::Scripting::ScriptClass::Register(Router_typeof(), uArray::Init< ::g::Fuse::Scripting::ScriptMethod*>(::TYPES[32/*Fuse.Scripting.ScriptMethod[]*/], 3, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[34/*Fuse.Scripting.ScriptMethod<Fuse.Navigation.Router>*/], ::STRINGS[26/*"goto"*/], uDelegate::New(::TYPES[35/*Uno.Action<Fuse.Navigation.Router, object[]>*/], (void*)Router__Goto1_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[34/*Fuse.Scripting.ScriptMethod<Fuse.Navigation.Router>*/], ::STRINGS[27/*"push"*/], uDelegate::New(::TYPES[35/*Uno.Action<Fuse.Navigation.Router, object[]>*/], (void*)Router__Push1_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[34/*Fuse.Scripting.ScriptMethod<Fuse.Navigation.Router>*/], ::STRINGS[28/*"goBack"*/], uDelegate::New(::TYPES[35/*Uno.Action<Fuse.Navigation.Router, object[]>*/], (void*)Router__GoBack1_fn), 2)));
}
...
void Router::Pop()
{
    ...
    if (uPtr(_history)->Count() == 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[33/*"Cannot pop(...*/], this, ::STRINGS[1/*"/usr/local/...*/], 1672, ::STRINGS[34/*"Pop"*/]);
        return;
    }
...
::g::Fuse::Navigation::Route* Router::SetRoute(::g::Fuse::Navigation::Route* r, int gotoMode, int operation, bool userRequest)
{
    ...
    if (outR == NULL)
    {
        ...
        if (userRequest)
            ::g::Fuse::Diagnostics::UserError(msg, this, ::STRINGS[1/*"/usr/local/...*/], 1694, ::STRINGS[36/*"SetRoute"*/]);
        else
            ::g::Fuse::Diagnostics::InternalError(msg, this, ::STRINGS[1/*"/usr/local/...*/], 1696, ::STRINGS[36/*"SetRoute"*/]);
...
::g::Fuse::Navigation::Route* Router::SetRouteImpl(::g::Fuse::Visual* root, ::g::Fuse::Navigation::Route* r, int gotoMode, int operation)
{
    ...
    if (outlet == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition1(::STRINGS[37/*"No router o...*/], r), this, ::STRINGS[1/*"/usr/local/...*/], 1713, ::STRINGS[38/*"SetRouteImpl"*/]);
        return NULL;
    }
    ...
    if (r->SubRoute != NULL)
    {
        if (active == NULL)
        {
            ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition1(::STRINGS[39/*"SubRoute re...*/], r), this, ::STRINGS[1/*"/usr/local/...*/], 1735, ::STRINGS[38/*"SetRouteImpl"*/]);
            return NULL;
        }
        else
        {
...
void Router::GoBack1(Router* r, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[29/*"GoBack take...*/], r, ::STRINGS[1/*"/usr/local/...*/], 1478, ::STRINGS[30/*"GoBack"*/]);
        return;
    }
...
void Router::Goto1(Router* r, uArray* args)
{
    ...
    if (where != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[31/*"Router.goto...*/], r, ::STRINGS[1/*"/usr/local/...*/], 1452, ::STRINGS[32/*"Goto"*/]);
}
...
{
    ::STRINGS[40] = uString::Const("Attempting to navigate to element with different parent");
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/0.32.14/$.uno");
    ::STRINGS[41] = uString::Const("GotoImpl");
    ::STRINGS[42] = uString::Const("Updated called without a region");
    ::STRINGS[43] = uString::Const("OnUpdated");
    ::STRINGS[44] = uString::Const("Seek being called on an unrooted navigation");
    ::STRINGS[45] = uString::Const("Seek");
...
void StructuredNavigation::GotoImpl(::g::Fuse::Visual* element, int mode)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[40/*"Attempting ...*/], element, ::STRINGS[1/*"/usr/local/...*/], 1990, ::STRINGS[41/*"GotoImpl"*/]);
        _active = NULL;
        return;
    }
...
void StructuredNavigation::Motion(::g::Fuse::Motion::MotionConfig* value)
{
    ...
    if (IsRootingCompleted())
        ::g::Fuse::Diagnostics::UserError(::STRINGS[46/*"Motion shou...*/], this, ::STRINGS[1/*"/usr/local/...*/], 1925, ::STRINGS[47/*"set_Motion"*/]);
}
...
void StructuredNavigation::OnUpdated()
{
    ...
    if (_region == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[42/*"Updated cal...*/], this, ::STRINGS[1/*"/usr/local/...*/], 2081, ::STRINGS[43/*"OnUpdated"*/]);
        return;
    }
...
void StructuredNavigation::Seek(::g::Fuse::Navigation::UpdateSeekArgs* args)
{
    ...
    if (_region == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[44/*"Seek being ...*/], this, ::STRINGS[1/*"/usr/local/...*/], 2273, ::STRINGS[45/*"Seek"*/]);
        return;
    }
...
{
    ::g::Fuse::Scripting::ScriptClass::Register(VisualNavigation_typeof(), uArray::Init< ::g::Fuse::Scripting::ScriptMethod*>(::TYPES[32/*Fuse.Scripting.ScriptMethod[]*/], 1, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[52/*Fuse.Scripting.ScriptMethod<Fuse.Navigation.VisualNavigation>*/], ::STRINGS[26/*"goto"*/], uDelegate::New(::TYPES[53/*Uno.Action<Fuse.Navigation.VisualNavigation, object[]>*/], (void*)VisualNavigation__gotoNode_fn), 2)));
}
...
void VisualNavigation::gotoNode(VisualNavigation* nav, uArray* args)
{
    ...
    if (target != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[48/*"Navigation....*/], nav, ::STRINGS[1/*"/usr/local/...*/], 3021, ::STRINGS[49/*"gotoNode"*/]);
}
// }
